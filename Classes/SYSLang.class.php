...
/** ----------------------------------------------------------------------------------------------------------------------- **/
	...
	protected $_files_repository = null;	// STRING	:: Dossier de dépot des packs de langue
...
/** ----------------------------------------------------------------------------------------------------------------------- **/
	...
	static function throw_error($message='', $error_level=E_USER_NOTICE){
		...
		trigger_error("$backtrace_message <br /><b> • ERROR ::</b> <b style='color: red;'>$message</b>", $error_level);
		echo "</pre>";
	}
...
/** ----------------------------------------------------------------------------------------------------------------------- **/
	...
	private function list_languages(){
		...
		if(file_exists($this->_files_repository.'/'.self::XML_CONF_FILE)){
			...
			$this->throw_error('File "languages.xml" not found.', E_USER_WARNING);
		}
	}
}
